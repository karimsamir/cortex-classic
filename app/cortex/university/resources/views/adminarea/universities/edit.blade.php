        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">@lang('Edit University'): {{ $university->name }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('adminarea.universities.update', $university) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('alt_name') is-invalid @enderror" 
                                           id="alt_name" name="alt_name" value="{{ old('alt_name', $university->alt_name) }}">
                                    @error('alt_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('state') is-invalid @enderror" 
                                           id="state" name="state" value="{{ old('state', $university->state) }}">
                                    @error('state')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                           id="city" name="city" value="{{ old('city', $university->city) }}">
                                    @error('city')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('street') is-invalid @enderror" 
                                           id="street" name="street" value="{{ old('street', $university->street) }}">
                                    @error('street')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('province') is-invalid @enderror" 
                                           id="province" name="province" value="{{ old('province', $university->province) }}">
                                    @error('province')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('postal_code') is-invalid @enderror" 
                                           id="postal_code" name="postal_code" value="{{ old('postal_code', $university->postal_code) }}">
                                    @error('postal_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('telephone') is-invalid @enderror" 
                                           id="telephone" name="telephone" value="{{ old('telephone', $university->telephone) }}">
                                    @error('telephone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('funding') is-invalid @enderror" 
                                           id="funding" name="funding" value="{{ old('funding', $university->funding) }}">
                                    @error('funding')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('academic_year') is-invalid @enderror" 
                                              id="academic_year" name="academic_year" rows="3">{{ old('academic_year', $university->academic_year) }}</textarea>
                                    @error('academic_year')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('accrediting_agency') is-invalid @enderror" 
                                              id="accrediting_agency" name="accrediting_agency" rows="3">{{ old('accrediting_agency', $university->accrediting_agency) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('languages') is-invalid @enderror" 
                                           ...
                                           value="{{ old('languages', is_array($university->languages) ? implode(', ', $university->languages) : $university->languages) }}" 
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> @lang('Update University')
                                    </button>
                                </div>
                            </div>
                        </div>
